...
class lihat_bahan_gudang : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener,DatePickerFragmentUntil.DialogDateListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_lihat_bahan_gudang)
...
//        date_until.setOnClickListener(this)
    ...
    private fun setupRecyclerView(){
        ...
        bahanAdapters.setOnItemClickCallback(object : bahanAdapter.OnItemClickCallback {
            override fun onItemClicked(data: bahanModel.Result) {
                ...
                updateOrder(data.id_order, data.id_cabang)
            }
    ...
    fun getBahan(mulai_dari: String, sampai_dengan: String){
        ...
        retro.getGudang(mulai_dari, sampai_dengan).enqueue(object : Callback<bahanModel> {
            ...
            override fun onFailure(call: Call<bahanModel>, t: Throwable) {
                showToast(this@lihat_bahan_gudang, "Terjadi kesalahan Saat Mengambil data", "info")
            }

        })
    }

    fun updateOrder(id_order : String, id_cabang : String){
        val retro = Retro().postRetroClient("https://riniocta.my.id/").create(bahanBakuAPI::class.java)
        retro.updateOrder(id_order, id_cabang).enqueue(object : Callback<bahanModel>{
            override fun onResponse(
                call: Call<bahanModel>,
                response: Response<bahanModel>
            ) {
